      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
                ...
                <button
                  onClick={() =>
                    openQuickLinkPage(
                      "Case Studies",
                      `
                      <h2 class="text-2xl font-semibold text-blue-400 mb-6">Success Stories</h2>
                      <div class="space-y-8 text-gray-300">
                        <p class="text-lg leading-relaxed">
                          Discover how InnovIA Technologies has helped organizations across various industries transform their operations with cutting-edge AI solutions.
                        </p>
                        <div class="space-y-8">
                          <div class="bg-gray-700/30 rounded-xl p-6 border-l-4 border-blue-400">
                            <h3 class="text-xl font-semibold text-white mb-3">Financial Services: Fraud Detection Revolution</h3>
                            <p class="text-gray-400 mb-4">A leading financial institution reduced fraud losses by 85% using our AI-powered real-time transaction monitoring system.</p>
                            <div class="grid md:grid-cols-3 gap-4 text-sm">
                              <div><strong class="text-blue-400">Challenge:</strong> High false positive rates in fraud detection</div>
                              <div><strong class="text-green-400">Solution:</strong> Advanced ML algorithms with behavioral analysis</div>
                              <div><strong class="text-purple-400">Result:</strong> 85% reduction in fraud losses, 60% fewer false positives</div>
                            </div>
                          </div>
                          <div class="bg-gray-700/30 rounded-xl p-6 border-l-4 border-purple-400">
                            <h3 class="text-xl font-semibold text-white mb-3">Healthcare: Diagnostic Accuracy Enhancement</h3>
                            <p class="text-gray-400 mb-4">Our medical imaging AI helped a hospital network improve diagnostic accuracy by 40% while reducing analysis time by 70%.</p>
                            <div class="grid md:grid-cols-3 gap-4 text-sm">
                              <div><strong class="text-blue-400">Challenge:</strong> Time-intensive medical image analysis</div>
                              <div><strong class="text-green-400">Solution:</strong> Deep learning models for automated diagnosis</div>
                              <div><strong class="text-purple-400">Result:</strong> 40% accuracy improvement, 70% faster analysis</div>
                            </div>
                          </div>
                          <div class="bg-gray-700/30 rounded-xl p-6 border-l-4 border-green-400">
                            <h3 class="text-xl font-semibold text-white mb-3">Education: Personalized Learning Platform</h3>
                            <p class="text-gray-400 mb-4">An educational institution saw 50% improvement in student engagement through our adaptive learning AI system.</p>
                            <div class="grid md:grid-cols-3 gap-4 text-sm">
                              <div><strong class="text-blue-400">Challenge:</strong> One-size-fits-all learning approach</div>
                              <div><strong class="text-green-400">Solution:</strong> AI-driven personalized content delivery</div>
                              <div><strong class="text-purple-400">Result:</strong> 50% higher engagement, 30% better outcomes</div>
                            </div>
                          </div>
                          <div class="bg-gray-700/30 rounded-xl p-6 border-l-4 border-orange-400">
                            <h3 class="text-xl font-semibold text-white mb-3">Supply Chain: Predictive Optimization</h3>
                            <p class="text-gray-400 mb-4">A global retailer achieved 25% cost reduction in logistics through our AI-powered supply chain optimization.</p>
                            <div class="grid md:grid-cols-3 gap-4 text-sm">
                              <div><strong class="text-blue-400">Challenge:</strong> Inefficient inventory and logistics management</div>
                              <div><strong class="text-green-400">Solution:</strong> Predictive analytics for demand forecasting</div>
                              <div><strong class="text-purple-400">Result:</strong> 25% cost reduction, 90% inventory accuracy</div>
                            </div>
                          </div>
                        </div>
                      </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">© 2024 InnovIA Technologies. All rights reserved.</p>
