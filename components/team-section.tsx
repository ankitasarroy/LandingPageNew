          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {coreMembers.map((member, index) => (
              <div key={index} className="group">
                <div className="bg-gray-900 rounded-2xl overflow-hidden border-2 border-purple-400/30 hover:border-purple-400/60 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-2xl">
                  {/* Hierarchy Indicator */}
