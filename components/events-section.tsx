...
const announcements = [
  {
    type: "announcement",
    title: "AI Learning Platform: Voice and Text Integration Breakthrough",
    description:
      "Our team is at the verge of achieving a revolutionary AI learning platform that seamlessly integrates voice and text capabilities, transforming how users interact with educational content.",
    date: "2024-01-30",
    category: "Innovation",
    priority: "high",
  },
